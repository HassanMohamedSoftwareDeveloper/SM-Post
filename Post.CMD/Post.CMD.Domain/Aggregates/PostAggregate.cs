...
public class PostAggregate : AggregateRoot
{
    ...
    public void LikePost()
    {
        if (!_active)
        {
            throw new InvalidOperationException("You cannot like of an inactive post!");
        }
    ...
    public void EditComment(Guid commentId, string comment, string username)
    {
        ...
        {
            throw new InvalidOperationException("You are not allowed to edit a comment that was made be another user!");
        }
    ...
    public void RemoveComment(Guid commentId, string username)
    {
        ...
        if (!_comments[commentId].Item2.Equals(username, StringComparison.CurrentCultureIgnoreCase))
        {
            throw new InvalidOperationException("You are not allowed to remove a comment that was made be another user!");
        }
    ...
    public void DeletePost(string username)
    {
        ...
        {
            throw new InvalidOperationException("You are not allowed to delete a post that was made be another user!");
        }
